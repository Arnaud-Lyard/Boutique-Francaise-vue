 ...
 */
final class Version20220318105114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD cart INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP cart, CHANGE product product VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
